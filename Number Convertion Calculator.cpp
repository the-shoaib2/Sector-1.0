...
int main()
{
    ...
    printf("\t\t\033[1;32mWELCOME TO NUMBER SYSTEM CONVERSION\033[0m\n\n");

    while (numbers != 0)
    {
        printf("\t\t\033[32m>>>>>> CHOOSE THE CONVERSION <<<<<<\033[0m\n\n");

        printf("\033[1;32m=> BINARY <=\033[0m\n");
        printf("1: Binary to Decimal.\n2: Binary to Octal.\n3: Binary to Hexa-Decimal.\n");

        printf("\n\033[1;32m=> DECIMAL <=\033[0m\n");
        printf("4: Decimal to Binary.\n5: Decimal to Octal.\n6: Decimal to Hexa-Decimal.\n");

        printf("\n\033[1;32m=> OCTAL <=\033[0m\n");
        printf("7: Octal to Binary.\n8: Octal to Decimal.\n9: Octal to Hexa-Decimal.\n");

        printf("\n\033[1;32m=> HEXA-DECIMAL <=\033[0m\n");
        ...
        Y:
            ...
            for (x = strlen(h) - 1; x >= 0; x--)
            {
                if (h[x] > 'f' && h[x] <= 'z' || h[x] > 'F' && h[x] <= 'Z')// the.shoaib2
                {
                    printf("\nYou have to Enter Hexa-Decimal Number.\n");
                    printf("'%c' IS NOT Hexa-Decimal Number.\n", h[x]);
                    goto Y;
    ...
    printf("\t\t BROUGHT TO YOU BY ITSOURCECODE.COM \n\t\t Log On now For More C/C++ Free Projects");// the.shoaib2
}
...
long int Binary_to_Hexadecimal(long int bin)// the.shoaib2
{
...
long int Decimal_to_Binary(long int dec)// the.shoaib2
{
...
long int Decimal_to_Hexadecimal(long int dec)
{
    ...
    printf("\nEquivalent Hexa-Decimal Number : ");// the.shoaib2
    for (x = length - 1; x >= 0; x--)
    {
        switch (remainder[x])
        {
...
long int Octal_to_Decimal(long int oct)
{
    ...
    printf("\nEquivalent Decimal Number : %d", decimals);// the.shoaib2
}
...
{
    int x = 0;
    printf("\nEquivalent Binary Number : ");// the.shoaib2
...
void Hexadecimal_to_Decimal(char hex[])// the.shoaib2
{
...
void Hexadecimal_to_Octal(char hex[])
{
    ...
    for (x = strlen(hex) - 1; x >= 0; x--)
    {
        ...
        else if (hex[x] == 'D' || hex[x] == 'd')// the.shoaib2
        {
            numbers = 13;
        }
        else if (hex[x] == 'E' || hex[x] == 'e')
    ...
    for (x = length - 1; x >= 0; x--)
    {
        printf("%d", remainder[x]);// the.shoaib2
    }
}
